            ...
            <Button
              ...
              onClick={() => {
                if (userDetails?.user?.mobile) {
                  window.open(
                    `https://wa.me/${userDetails.user.mobile.replace(
                      /\D/g,
                      ""
                    )}`,
                    "_blank"
              ...
              disabled={!userDetails?.user?.mobile}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <Button
              ...
              onClick={() => {
                if (userDetails?.user?.email) {
                  window.open(`mailto:${userDetails.user.email}`, "_blank");
                }
              }}
              disabled={!userDetails?.user?.email}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4 mr-2"
